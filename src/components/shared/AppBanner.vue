...
<template>
	<section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<p
				class="font-general-medium mt-4 text-lg sm:text-2xl  xl:text-2xl  text-center sm:text-left  text-gray-400">
				Currently a student in Computer Science at University of Nottingham Ningbo China (UNNC).<br />
				A Full-Stack Web Developer, a Tech Enthusiast, and a Lifelong Learner.<br />
				Also fan of <img src="@/assets/images/HP.png" alt="Harry Potter"
					class="inline-block h-7 align-middle m-2" />, LEGO and Euro Truck Simulator 2.
			</p>
			<div class="flex justify-center sm:block">
				<a download="Gentle-Lijie-Resume.pdf"
					href="javascript:alert('Please contact me via email to get my resume.');"
